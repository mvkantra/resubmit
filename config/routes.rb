Loging::Application.routes.draw do
  match '/likes/likeaction',:controller =>'likes', :action=> :likeaction
  resources :likes
   match '/logins/logout', :controller => 'logins', :action => 'logout'
  match '/logins/homelog', :controller => :logins, :action => 'homelog'
  resources :logins
  match '/posts/search', :controller => 'posts', :action => 'search'
  match '/posts/reply', :controller => 'posts', :action => 'reply'
  resources :posts
